...
<body style="background-color: #FFFAD7">
  ...
  <br><br><br><br>
    ...
    <input type="text" id="TxtCorreo" class="textbox"><br><br>
    CONTRASEÑA <br>
    <input type="text" id="TxtContrasena" class="textbox"><br>
    <a href="" style="font-size:14">No tengo una cuenta</a>
  </div>
  <button class="Boton">Iniciar Sesión</button>
  <div class="icono">
  <img src="../img/usuario.png" style="width:80%; top:10%; border-radius:50%; ">
  </div>
